...
?>
        <div class="mythemes-top-meta meta">
            ...
            <a class="author" href="<?php echo esc_url( get_author_posts_url( $post-> post_author ) ); ?>" title="<?php echo sprintf( __( 'Written by %s' , 'cannyon' ) , esc_attr( $name ) ); ?>"><?php echo sprintf( __( 'by %s' , 'cannyon' ) , esc_html( $name ) ); ?></a>
