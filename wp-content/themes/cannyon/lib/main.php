...
require_once get_template_directory() . '/lib/mythemes.deb.class.php';
...
require_once get_template_directory() . '/lib/mythemes.meta.class.php';
require_once get_template_directory() . '/lib/mythemes.options.class.php';
...
if( is_admin() ){
	...
	/* INCLUDE RESOURCES */
	require_once get_template_directory() . '/lib/mythemes.ahtml.class.php';
